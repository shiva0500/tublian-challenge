        ...
        <label className="payment-checkbox">
          ...
          <div className="user-payment-details">
            ...
            <p style={{ fontSize: "12px" }}>
              By clicking below, you agree to our Terms, Privacy Policy and
              Automatic Renewal. Tublian will charge you $49.99 (plus Tax) each
              month until you cancel you subscription in account settings.
            </p>
            <br />
            <DefaultButton
          name="Pay $49.99"
